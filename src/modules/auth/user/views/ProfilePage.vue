...
const tabs = [
  { title: t('user.user.profile.tabs.info'), icon: 'tabler-user', tab: 'info' },
  { title: t('user.user.profile.tabs.trends'), icon: 'tabler-chart-line', tab: 'trends' },
  { title: t('user.user.profile.tabs.activities'), icon: 'tabler-history', tab: 'activities' },
  { title: t('user.user.profile.tabs.notifications'), icon: 'tabler-bell', tab: 'notifications' },
]
</script>
