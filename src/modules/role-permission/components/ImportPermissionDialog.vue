...
<template>
  ...
  >
    ...
    <VCard title="Nhập danh sách quyền">
      <VCardText>
        <div class="mb-4">
          <p class="text-body-1 text-high-emphasis mb-1">
            Tải tệp dữ liệu quyền
          </p>
          <p class="text-body-2 text-medium-emphasis mb-0">
            Hỗ trợ tệp `.xlsx` và `.csv`. Dùng file mẫu để đúng cấu trúc cột.
          </p>
        </div>
        ...
        >
          <VRow>
            ...
            <VCol cols="12">
              ...
              >
                Cột chuẩn theo Core API: `name`, `guard_name`, `description`, `sort_order`, `parent_id`.
              </VAlert>
            </VCol>
          </VRow>
        </VForm>
