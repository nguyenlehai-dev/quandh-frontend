...
export const navigation = createMeetingsNavigationGroup({
  ...
  children: [
    ...
    createMeetingsNavigationItem({ titleKey: 'navigation.navigation.meetings.votes_list', to: 'meetings-votes-list', subject: 'MeetingVoting' }),
    createMeetingsNavigationItem({ titleKey: 'navigation.navigation.meetings.documents_list', to: 'meetings-documents-list', subject: 'MeetingDocument' }),
    createMeetingsNavigationItem({ titleKey: 'navigation.navigation.meetings.conclusions_list', to: 'meetings-conclusions-list', subject: 'MeetingConclusion' }),
    createMeetingsNavigationGroup({
      ...
      children: [
        ...
        createMeetingsNavigationItem({ titleKey: 'navigation.navigation.meetings.document_types', to: 'meetings-document-types', subject: 'MeetingDocumentType' }),
        createMeetingsNavigationItem({ titleKey: 'navigation.navigation.meetings.document_fields', to: 'meetings-document-fields', subject: 'MeetingDocumentField' }),
