...
export const changePostStatus = (id, status) => $api(`${API_POSTS}/${id}/status`, { method: 'PATCH', body: { status } })
...
export const changePostCategoryStatus = (id, status) => $api(`${API_POST_CATEGORIES}/${id}/status`, { method: 'PATCH', body: { status } })
