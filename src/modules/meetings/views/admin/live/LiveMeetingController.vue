  ...
  <div class="h-100 d-flex flex-column surface-ground">
    ...
    <template v-if="!loading && meeting">
      ...
      <div class="px-4 pt-4 mb-4">
        <VCard elevation="0" style="border-radius: 12px; background: linear-gradient(135deg, #f0f9ff 0%, #e0e7ff 100%);">
          <div class="d-flex align-center justify-space-between w-100" style="padding: 24px 32px;">
            <!-- Left side -->
            <div class="d-flex flex-column gap-2" style="max-width: 60%">
              <div class="d-flex align-center mb-1">
                <VChip size="small" variant="flat" color="white" style="color: #6366f1; border: 1px solid #c7d2fe; font-weight: 600;">
                  <VIcon start size="16" color="#6366f1">tabler-calendar-event</VIcon> {{ meeting.location || 'Cuộc họp' }}
                </VChip>
              </div>
              <h2 class="text-h4 font-weight-black mb-0 text-uppercase" style="color: #334155; line-height: 1.2;">
                {{ meeting.title || 'Đang tải...' }}
              </h2>
              <div class="text-body-1 mt-1" style="color: #475569; font-weight: 500;">
            ...
            <div class="d-flex flex-column align-end gap-3">
              <!-- Timer Box -->
              <VCard elevation="0" class="px-5 py-3" style="border-radius: 16px; min-width: 320px; box-shadow: 0 4px 15px rgba(0,0,0,0.02) !important;">
                <div class="d-flex justify-space-between align-start mb-1">
                  <span class="text-caption font-weight-bold text-uppercase" style="color: #94a3b8; letter-spacing: 0.5px;">Thời gian còn lại</span>
                  <VChip
                    size="small"
                ...
                <div class="d-flex align-center gap-2">
                  <VAvatar color="#fee2e2" size="36" variant="flat" class="mr-1">
                    <VIcon size="20" color="#ef4444">tabler-hourglass-high</VIcon>
                  </VAvatar>
                  <span class="font-weight-bold" style="font-size: 2.25rem; color: #475569; font-variant-numeric: tabular-nums; line-height: 1;">
                    {{ countdownDisplay }}
                  </span>
                </div>
              </VCard>
              ...
              <div class="d-flex gap-3">
                <VBtn
                  v-if="meetingStatus === 'draft' || meetingStatus === 'scheduled'"
                  color="success"
                  variant="flat"
      ...
      <VContainer fluid class="flex-grow-1 px-4 py-0" style="min-height: calc(100vh - 230px);">
        <!-- Tabs Setup -->
        <VCard class="mb-4" elevation="0" style="border-radius: 12px; border: 1px solid #f1f1f4; overflow: hidden; box-shadow: 0 4px 14px rgba(0,0,0,0.02) !important;">
          <VTabs
            v-model="activeTab"
            color="primary"
            bg-color="white"
            ...
            show-arrows
          >
            <VTab value="agenda" class="text-subtitle-2 font-weight-bold text-none px-6" style="letter-spacing: normal;">
              <VIcon start size="20">tabler-list-details</VIcon> Chương trình họp
            </VTab>
            <VTab value="documents" class="text-subtitle-2 font-weight-bold text-none px-6" style="letter-spacing: normal;">
              <VIcon start size="20">tabler-file-text</VIcon> Tài liệu họp
            </VTab>
            <VTab value="executive" class="text-subtitle-2 font-weight-bold text-none px-6" style="letter-spacing: normal;">
              <VIcon start size="20">tabler-adjustments-alt</VIcon> Thông tin điều hành
            </VTab>
            <VTab value="voting" class="text-subtitle-2 font-weight-bold text-none px-6" style="letter-spacing: normal;">
              <VIcon start size="20">tabler-checkbox</VIcon> Biểu quyết
            </VTab>
            <VTab value="conclusions" class="text-subtitle-2 font-weight-bold text-none px-6" style="letter-spacing: normal;">
              <VIcon start size="20">tabler-file-check</VIcon> Kết luận cuộc họp
            </VTab>
          </VTabs>
        </VCard>
        ...
        >
          <VWindowItem value="agenda" transition="none" reverse-transition="none">
          ...
          <VWindowItem value="executive" transition="none" reverse-transition="none">
