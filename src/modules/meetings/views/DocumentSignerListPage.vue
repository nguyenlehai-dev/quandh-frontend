<script setup>
import { deleteDocumentSigner, createDocumentSigner, updateDocumentSigner, exportDocumentSigners } from '@/modules/meetings/services/meetingService'
...
const deleteItem = async id => {
  if (confirm('Xóa người ký này?')) {
    await deleteDocumentSigner(id)
    fetchItems()
  }
}
