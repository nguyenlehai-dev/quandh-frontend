<script setup>
import { deleteIssuingLevel, createIssuingLevel, updateIssuingLevel, exportIssuingLevels } from '@/modules/meetings/services/meetingService'
...
const submitForm = async () => {
  if (!formData.value.name) {
    alert('Vui lòng nhập tên cấp ban hành')
...
const deleteItem = async id => {
  if (confirm('Xóa cấp ban hành này?')) {
    await deleteIssuingLevel(id)
    fetchItems()
  }
}
