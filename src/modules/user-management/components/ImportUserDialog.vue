...
<template>
  ...
  >
    ...
    <VCard title="Nhập danh sách người dùng">
      <VCardText>
        <div class="mb-4">
          ...
          <p class="text-body-2 text-medium-emphasis mb-0">
            Hệ thống hỗ trợ tệp `.xlsx` và `.csv`. Nên dùng file mẫu để đảm bảo đúng cột dữ liệu.
          </p>
        </div>
        ...
        >
          <VRow>
            ...
            <VCol cols="12">
              ...
              >
                Cột chuẩn theo Core API: `name`, `email`, `user_name`, `password`, `status`, `assignments`.
              </VAlert>
            </VCol>
          </VRow>
        </VForm>
